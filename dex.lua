    ...
    local function main()
        ...
        Lib.CodeFrame = (function()
            ...
            funcs.HighlightLine = function(self,line)
                ...
                for col = 1,#lineText do-- highlights[col] = currentType
                    if col <= lastEnding then
                        highlights[col] = currentType
                    end

                    if not (col <= lastEnding) then
    ...
    local function main()
        ...
        ScriptViewer.ViewScript = function(scr)
            ...
            if not s or not source then
                source = "-- decompilation is on hold right now\n--   - wyatt"
            end
    ...
    Main = (function()
        ...
        Main.FetchAPI = function()
            ...
            if Main.Elevated then
                ...
                rawAPI = rawAPI or game:HttpGet("http://setup.roblox.com.s3.amazonaws.com/"..Main.RobloxVersion.."-API-Dump.json")
            else
        ...
        Main.Init = function()
            ...
            if Main.Elevated then
                ...
                Main.RobloxVersion = Main.RobloxVersion or game:HttpGet("http://setup.roblox.com.s3.amazonaws.com/versionQTStudio")
            end
