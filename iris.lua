...
function __Internal(Iris: Iris): Internal
    --[=[
        @class Internal
...
local Internal: Internal = __Internal(Iris)
...
function __DemoWindow(Iris: Iris)
...
Iris.ShowDemoWindow = __DemoWindow(Iris)

function __API(Iris: Iris)
...
function __widgets(Iris: Internal)
	...
	local function __Root(Iris: Internal, widgets: WidgetUtility)
	...
	local function __Window(Iris: Internal, widgets: WidgetUtility)
	...
	local function __Menu(Iris: Internal, widgets: WidgetUtility)
	...
	local function __Format(Iris: Internal, widgets: WidgetUtility)
		--stylua: ignore
	...
	local function __Text(Iris: Internal, widgets: WidgetUtility)
		--stylua: ignore
	...
	local function __Button(Iris: Internal, widgets: WidgetUtility)
	...
	local function __Checkbox(Iris: Internal, widgets: WidgetUtility)
		--stylua: ignore
	...
	local function __RadioButton(Iris: Internal, widgets: WidgetUtility)
		--stylua: ignore
	...
	local function __Tree(Iris: Internal, widgets: WidgetUtility)
		local abstractTree = {
			hasState = true,
			hasChildren = true,
			Events = {
	...
	local function __Input(Iris: Internal, widgets: WidgetUtility)
		local numberChanged = {
			["Init"] = function(_thisWidget: Widget) end,
			["Get"] = function(thisWidget: Widget)
	...
	local function __Combo(Iris: Internal, widgets: WidgetUtility)
	...
	local function __Plot(Iris: Internal, widgets: WidgetUtility)
		Iris.WidgetConstructor(
			"ProgressBar",
			{
				hasState = true,
	...
	local function __Table(Iris: Internal, widgets: WidgetUtility)
	...
	__Root(Iris, widgets)
	__Window(Iris, widgets)

	__Menu(Iris, widgets)

	__Format(Iris, widgets)

	__Text(Iris, widgets)
	__Button(Iris, widgets)
	__Checkbox(Iris, widgets)
	__RadioButton(Iris, widgets)

	__Tree(Iris, widgets)

	__Input(Iris, widgets)
	__Combo(Iris, widgets)
	__Plot(Iris, widgets)

	__Table(Iris, widgets)
end
